...
// get is an internal helper to simplify the Get implementation
func (f *BasicFacts) get(path string) (interface{}, bool) {
	if f.rawJSON == "" || path == "" {
		return nil, false
	}
