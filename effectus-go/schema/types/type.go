...
// Compatibility aliases for transitioning code
func (t *Type) ListType() *Type {
	return t.ElementType
}

// GetMapKeyType is a compatibility method for code transition
func (t *Type) GetMapKeyType() *Type {
	return t.MapKeyType()
}

// GetMapValType is a compatibility method for code transition
func (t *Type) GetMapValType() *Type {
