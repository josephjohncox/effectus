...
func TestEffectusdGeneratedGRPCServiceUsesDurableEngine(t *testing.T) {
	...
	oldDSN, oldAddr, oldInsecure, oldAuth := *postgresDSN, *grpcAddr, *grpcAllowInsecure, *apiAuthMode
	t.Cleanup(func() {
		*postgresDSN, *grpcAddr, *grpcAllowInsecure, *apiAuthMode = oldDSN, oldAddr, oldInsecure, oldAuth
	})
	*postgresDSN, *grpcAddr, *grpcAllowInsecure, *apiAuthMode = dsn, "127.0.0.1:0", true, "disabled"
