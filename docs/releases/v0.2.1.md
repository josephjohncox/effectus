...
**Historical release note.** Commands, adapters, metrics, and support claims below describe this version, not the current checkout.
Do not use these migration commands for the current daemon. Use the current [command reference](../COMMANDS.md) and [runtime guarantees](../GUARANTEES.md).
